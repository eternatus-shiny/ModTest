...
public class HamletDwellerModel extends EntityModel<LivingEntity> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(References.MODID, "hamlet_dweller"), "main");
	private static final String name = "hamlet_dweller";
	...
	public HamletDwellerModel(ModelPart root) {
	...
	public ResourceLocation getTextureLocation(HamletDwellerEntity object){
		return HamletDwellerRenderer.LOCATION_BY_VARIANT.get(object.getProfession());
	}
}