...
public class CanoeModel extends ListModel<CanoeEntity> {
	...
	public CanoeModel(ModelPart root) {
		...
		this.waterPatch = root.getChild("root").getChild("water_patch");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition water_patch = root.addOrReplaceChild("water_patch", CubeListBuilder.create().texOffs(38, 50).addBox(-9.0F, -31.0F, -33.0F, 18.0F, 9.0F, 56.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		return LayerDefinition.create(meshdefinition, 256, 115);
	}
