...
public class CaveBiomeMapWorldWorker implements WorldWorkerManager.IWorker {
    ...
    private static final int SAMPLE_INCREMENT = ConfigLib.caveMapSearchWidth.get();
    private int width = 0;
    ...
    public boolean hasWork() {
        boolean ret = !complete && samples < ConfigLib.caveMapSearchAttempts.get() && !this.serverLevel.getServer().isStopped();
        if(!ret){
